...
END:VCARD` );
this._historialService.agregar_historial("MATMSG:TO:melissa.cuetosilva@gmail.com;SUB:Generador QR;BODY:El correo ha sido enviado desde aplicación QRAPP;;");
